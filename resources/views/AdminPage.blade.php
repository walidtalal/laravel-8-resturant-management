            ...
            <div class="col-md-12">
                <nav class="breadcrumb">
                    <ol class="breadcrumb bg-warning">
                        <li class="breadcrumb-item active fs-4" aria-current="page">طلبات الزبائن</li>
                    </ol>
                </nav>
                <div class="card">
                    <div class="card-header">
                        <a style="float:right;" href="{{route("cat.index")}}"><button class="btn btn-success btn-default"
                                                                                       style="margin-left:6px ;">إضافة صنف جديد </button></a>

                        <a style="float:right;" href="{{route('meal.create')}}"><button class="btn btn-danger"
